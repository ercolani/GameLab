	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g20711 = Base_Extras_RGB213_g18625;
				half sRGB8_g20711 = temp_output_9_0_g20711;
				half localGammaToLinearFloatFast8_g20711 = GammaToLinearFloatFast( sRGB8_g20711 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g20711 = temp_output_9_0_g20711;
				#else
				float staticSwitch1_g20711 = localGammaToLinearFloatFast8_g20711;
				#endif
				half3 appendResult239_g18625 = (half3(0.0 , 0.0 , staticSwitch1_g20711));
				...
				half4 break469_g18625 = saturate( ( ( tex2DNode17_g18625 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20725 ) ) );
				...
				half2 temp_output_851_0_g18625 = saturate( ( ( abs( (( (temp_output_35_0_g20714).zw + ( (temp_output_35_0_g20714).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20730 ) ) );
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;1363.536;1856.973;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;113;-640,-1408;Inherit;False;Define Element Extras;61;;20734;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=23C8121B41904ACBAF1AD3163AE8657B4EA1D082