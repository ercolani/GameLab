	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g20713 = Base_Extras_RGB213_g19342;
				half sRGB8_g20713 = temp_output_9_0_g20713;
				half localGammaToLinearFloatFast8_g20713 = GammaToLinearFloatFast( sRGB8_g20713 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g20713 = temp_output_9_0_g20713;
				#else
				float staticSwitch1_g20713 = localGammaToLinearFloatFast8_g20713;
				#endif
				half3 appendResult890_g19342 = (half3(staticSwitch1_g20713 , 0.0 , 0.0));
				...
				half4 break469_g19342 = saturate( ( ( tex2DNode17_g19342 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20725 ) ) );
				...
				half2 temp_output_851_0_g19342 = saturate( ( ( abs( (( (temp_output_35_0_g20714).zw + ( (temp_output_35_0_g20714).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20730 ) ) );
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;1677.536;1757.973;1;True;False
Node;AmplifyShaderEditor.FunctionNode;113;-640,-1408;Inherit;False;Define Element Extras;61;;19324;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F9AC820945667D4F6B393260A6D995EA793524D7