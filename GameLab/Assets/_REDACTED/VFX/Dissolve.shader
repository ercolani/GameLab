...
Shader "REDACTED/Dissolve"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][HDR]_MainColor("MainColor", Color) = (0.1605553,0.5429555,0.8301887,1)
		[HDR]_EdgeColor("EdgeColor", Color) = (0.9137255,0.2181493,0.1098039,1)
		[ASEEnd]_Alpha("Alpha", Range( 0 , 1)) = 0.3984835
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float simpleNoise12 = SimpleNoise( texCoord16*77.9 );
				float temp_output_21_0 = ( 1.0 - _Alpha );
				
				float3 Albedo = _MainColor.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( step( simpleNoise12 , ( 0.01 + temp_output_21_0 ) ) * _EdgeColor ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = simpleNoise12;
				float AlphaClipThreshold = temp_output_21_0;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = simpleNoise12;
				surfaceDescription.AlphaClipThreshold = temp_output_21_0;
...
/*ASEBEGIN
Version=18935
7;576;1920;443;1658.839;124.3155;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-1293.682,-88.06095;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-1548.5,317.4229;Inherit;False;Property;_Alpha;Alpha;2;0;Create;True;0;0;0;False;0;False;0.3984835;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;14;-701.2194,232.6352;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;21;-1180.863,320.1526;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-733.6575,484.2048;Inherit;False;Property;_EdgeColor;EdgeColor;1;1;[HDR];Create;True;0;0;0;False;0;False;0.9137255,0.2181493,0.1098039,1;0.7529412,5.992157,5.772549,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;12;-1022.777,-89.42953;Inherit;True;Simple;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;77.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;10;-439.4001,-76.6;Inherit;False;Property;_MainColor;MainColor;0;1;[HDR];Create;True;0;0;0;False;0;False;0.1605553,0.5429555,0.8301887,1;0.3018868,0.2535147,0.2321111,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-441.0979,236.2824;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-969.705,239.3244;Inherit;False;2;2;0;FLOAT;0.01;False;1;FLOAT;0.5;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C1D17F78AF5FB91CFBAE849A58C95154E244264D