...
Shader "REDACTED/Dissolve"
{
	Properties
	{
		...
		[ASEBegin]_EdgeThickness("Edge Thickness", Float) = 0.02
		[HDR]_Color("Color", Color) = (0,5.270588,16,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float simpleNoise10 = SimpleNoise( texCoord11*30.0 );
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _Color * step( simpleNoise10 , ( _EdgeThickness + _TimeParameters.y ) ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = simpleNoise10;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = simpleNoise10;
...
/*ASEBEGIN
Version=18935
65;320;1906;1013;1023.881;186.3456;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-1426.03,-254.2492;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;22;-1387.049,-93.53641;Inherit;False;Constant;_NoiseScale;Noise Scale;2;0;Create;True;0;0;0;False;0;False;30;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;15;-347.0147,-305.5022;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.54;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;10;-1118.03,-138.2492;Inherit;True;Simple;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;30;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinTimeNode;13;-1018.194,225.151;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;23;-120.8809,188.6544;Inherit;False;Property;_Alpha;Alpha;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-581.5236,31.79201;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-833.5181,33.62012;Inherit;False;Property;_EdgeThickness;Edge Thickness;0;0;Create;True;0;0;0;False;0;False;0.02;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;4.481934,-335.3799;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;21;-346.5181,-555.3799;Inherit;False;Property;_Color;Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0,5.270588,16,0;0,5.207843,15.74902,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CBF85C6788A0CD02F38ED6415186D98DF1EEF084