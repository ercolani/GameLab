...
Shader "REDACTED/Fish"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_WobbleFrequency("WobbleFrequency", Float) = 0
		_WobbleSpeed("WobbleSpeed", Float) = 0
		_WobbleDistance("WobbleDistance", Float) = 0
		_LerpAlpha("LerpAlpha", Vector) = (0,0,0,0)
		_WobbleScale("WobbleScale", Float) = 0.2
		[ASEEnd][HDR]_GlowColor("GlowColor", Color) = (0,0.6842999,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 break39 = ase_worldViewDir;
				float4 appendResult41 = (float4(( _WobbleDistance * sin( ( ( ( _TimeParameters.z * _WobbleScale ) * _WobbleSpeed ) + ( ase_worldPos.z * _WobbleFrequency ) ) ) ) , break39.y , break39.z , 0.0));
				float4 lerpResult36 = lerp( float4( v.vertex.xyz , 0.0 ) , appendResult41 , float4( _LerpAlpha , 0.0 ));
				...
				#endif
				float3 vertexValue = lerpResult36.xyz;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float3 Albedo = color50.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = _GlowColor.rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
/*ASEBEGIN
Version=18935
239;329;1190;622;507.6301;738.1;1.477177;True;True
Node;AmplifyShaderEditor.WorldPosInputsNode;16;-1245.275,229.1957;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;45;-1184.178,-30.09433;Inherit;False;Property;_WobbleScale;WobbleScale;4;0;Create;True;0;0;0;False;0;False;0.2;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CosTime;27;-1231.008,-205.733;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-919.1785,-138.0943;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1012.418,85.1619;Inherit;False;Property;_WobbleSpeed;WobbleSpeed;1;0;Create;True;0;0;0;False;0;False;0;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-981.2753,448.1957;Inherit;False;Property;_WobbleFrequency;WobbleFrequency;0;0;Create;True;0;0;0;False;0;False;0;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;18;-989.2753,274.1957;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-774.9084,-21.33298;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-743.1753,267.1957;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;29;-590.0084,123.267;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;40;-574.7659,311.6261;Inherit;True;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;33;-607.0084,-226.7329;Inherit;False;Property;_WobbleDistance;WobbleDistance;2;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;31;-576.0084,-84.73294;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;39;-278.878,328.7887;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-367.0085,-136.7329;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;42;-26.13322,255.1967;Inherit;False;Property;_LerpAlpha;LerpAlpha;3;0;Create;True;0;0;0;False;0;False;0,0,0;0.05,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;41;-111.6659,76.48627;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.PosVertexDataNode;34;-202.7621,-381.55;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;36;169.6629,-143.1454;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;47;285.1774,37.46773;Inherit;False;Constant;_Float0;Float 0;5;0;Create;True;0;0;0;False;0;False;0.95;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;50;507.532,-564.6411;Inherit;False;Constant;_Color1;Color 0;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;46;175.773,-413.5657;Inherit;False;Property;_GlowColor;GlowColor;5;1;[HDR];Create;True;0;0;0;False;0;False;0,0.6842999,1,1;0,0.6842999,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=321EB290E04773937A2915F298094B13F87C3A9E